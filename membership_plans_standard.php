...
<head>
    ...
    <title>Update Membership Plan</title>
    <style>
        * {
...
<body>
    <div class="close-icon" onclick="window.location.href='user_home.php'">&times;</div>
    <div class="container">
        <h1>Upgrade Membership Plan</h1>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            planCard.addEventListener('click', () => {
                if (isSelected) {
                    ...
                    isSelected = true;
                    selectedMembershipId = 4; // Premium membership ID
                }
            });
