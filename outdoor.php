...
<body>
    ...
    <section class="image-grid">
        <!-- Row 1 of 4 images -->
        <div class="image">
            <img src="img/out1.png" alt="Outdoor Game 1">
            <div class="overlay">
                <h3>SWIMMING</h3>
        ...
        <div class="image">
            <img src="img/out2.png" alt="Outdoor Game 2">
            <div class="overlay">
                <h3>HORSE RIDING</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
        ...
        <div class="image">
            <img src="img/out3.png" alt="Outdoor Game 3">
            <div class="overlay">
                <h3>BASKET BALL</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
        ...
        <div class="image">
            <img src="img/out4.png" alt="Outdoor Game 4">
            <div class="overlay">
                <h3>GOLF</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
        ...
        <!-- Row 2 of 4 images -->
        <div class="image">
            <img src="img/out5.png" alt="Outdoor Game 5">
            <div class="overlay">
                <h3>TENNIS</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
        ...
        <div class="image">
            <img src="img/out6.png" alt="Outdoor Game 6">
            <div class="overlay">
                <h3>BADMINTON</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
        ...
        <div class="image">
            <img src="img/out7.png" alt="Outdoor Game 7">
            <div class="overlay">
                <h3>FOOTBALL</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
        ...
        <div class="image">
            <img src="img/out8.png" alt="Outdoor Game 8">
            <div class="overlay">
                <h3>ROLLER SKATES</h3>
                <a href="signup.php"><button class="book-now">Book Now</button></a>
            </div>
