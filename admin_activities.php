...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-item active"><a href="admin_activities.php">Activities</a></li>
...
document.querySelectorAll('.btn-edit').forEach(button => {
    button.addEventListener('click', function() {
        ...
        const activityTypeCell = row.querySelector('td:nth-child(1)');
        ...
        saveBtn.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert(data.message);
                    activityTypeCell.innerHTML = originalContent; // Restore original content on error
                }
            })
            .catch(error => {
        ...
        cancelBtn.addEventListener('click', function() {
            activityTypeCell.innerHTML = originalContent; // Restore original content
        });
    });
});
